...
country_income <- read_csv(here("wk-05/hw-05a-practice/data/what_a_waste/what-a-waste-city-level-data-country-income.csv"))
```
...
4.  Navigate to the generated PDF: `wk-05/hw-05a-practice/section-02.pdf`
