...
The original source of this data is from [washdata.org](https://washdata.org/)  WHO/UNICEF Joint Monitoring Programme for Water Supply and Sanitation. Data was pre-processed to prepare data in a consisent format follows tidy data principles. The code and imported data can be accessed in the [larnsce/washr GitHub repository](https://github.com/larnsce/washr).
