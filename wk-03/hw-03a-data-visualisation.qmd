...
gapminder_yr_2007 <- read_rds(here::here("wk-03/data/gapminder-yr-2007.rds"))

gapminder_summary_continent_2007 <- read_rds(here::here("wk-03/data/gapminder-summary-continent-2007.rds"))

gapminder_summary_continent_year <- read_rds(here::here("wk-03/data/gapminder-summary-continent-year.rds"))
...
1.  Load the R Packages `sf` and the `rnaturalearth`using the `library()` at the beginning of this file alongside the other loaded R Packages.
