...
1.  Use the `read_csv()` and `here()` functions to import the following two CSV files from the "wk-05/hw-05a-practice/data/what_a\_waste/" directory:
...
4.  Navigate to the generated PDF: `wk-05/hw-05a-practice/section-01.pdf`
